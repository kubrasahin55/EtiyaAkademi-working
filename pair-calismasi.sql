--Kategori tablosundaki kategori adını a dan z ye sıralayan sorgu
Select*from categories order by category_name;
--Tüm ürünlerin fiyat ortalamasını alan sorgu
Select Avg(unit_price)from products ;
--Product tablosunda name kolonunda "l" olanları sıralayan sorgu
Select*from products where lower (name) like '%l%';
--Product tablosundaki Ürün adlı kolondaki birim fiyatı 10 ile 100 arasında olanları bulan sorgu
Select*from products where unit_price>10 and unit_price<100;
--Product tablosundaki stok adedi 30dan küçük olan ürünlerin büyükten küçüğe sıralanması
